...
/// base : "stations"
/// main : {"temp":291.14,"feels_like":291.29,"temp_min":291.14,"temp_max":291.14,"pressure":1016,"humidity":88}
/// visibility : 1000
...
class WeatherModal {
  ...
  WeatherModal.fromJson(dynamic json) {
  ...
  String? _name;
  num? _cod;
  WeatherModal copyWith({  Coord? coord,
    List<Weather>? weather,
    String? base,
    Main? main,
    num? visibility,
    ...
    String? name,
    num? cod,
  }) => WeatherModal(  coord: coord ?? _coord,
